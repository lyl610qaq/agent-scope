...
class AgentRuntimeConfigControllerTest {
    ...
    void runtimeConfigEndpointReturnsEffectiveSettings() throws Exception {
        mockMvc.perform(get("/api/config"))
                ...
                .andExpect(jsonPath("$.ruoyiAuth.loginPath").doesNotExist())
                .andExpect(jsonPath("$.ruoyiAuth.logoutPath").doesNotExist())
                .andExpect(jsonPath("$.ruoyiAuth.mePath").doesNotExist())
